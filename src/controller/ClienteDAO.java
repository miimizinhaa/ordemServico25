...
public class ClienteDAO {
    ...
    public ClienteDAO(){
       ...
       public Cliente buscarCliente(int IdCli, Connection con){
           try{
               ...
               if(rs.next()){
                   ...
                   clientes.setIdCli(rs.getInt("idcli"));
        ...
        public void alterarCliente(Cliente obj, Connection con){
            try{
